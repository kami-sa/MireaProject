 ...
 * Use the {@link nav_recorder#newInstance} factory method to
 * create an instance of this fragment.
 */

public class nav_recorder extends Fragment implements View.OnClickListener{
     ...
     * @return A new instance of fragment nav_recorder.
     */
    // TODO: Rename and change types and number of parameters
    public static nav_recorder newInstance(String param1, String param2) {
        nav_recorder fragment = new nav_recorder();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nav_recorder, container, false);
        startRecordButton = view.findViewById(R.id.btnStart);
        stopRecordButton = view.findViewById(R.id.btnPause);
...
// создание файла
                audioFile = new File(getActivity().getExternalFilesDir(
                        Environment.DIRECTORY_MUSIC), "mirea3.3gp");
            }
    ...
    private void stopRecording() {
        if (mediaRecorder != null) {
            ...
            Toast.makeText(getActivity(), "Запись окончена", Toast.LENGTH_SHORT).show();
        }
    }
